...
- **ggplot2**: Para la visualización de la línea de tiempo de observaciones.
- **shinydashboard**: Para estructurar el diseño del panel de la aplicación.
- **httr**: Para interactuar con la API de GBIF (si es necesario).
